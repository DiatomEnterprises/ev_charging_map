      ...
      <div className="static list-info">
        {this.props.markers.map(marker => (
          <div key={marker.id} className="list-item">
            ...
            <p><i className="fas fa-map-marker-alt" /> lat: {marker.AddressInfo.Latitude}, lng: {marker.AddressInfo.Longitude} <a href={"https://www.google.com/maps/dir/?api=1&destination="+marker.AddressInfo.Latitude+","+marker.AddressInfo.Longitude} target="_blank"> Navigate! </a></p>
